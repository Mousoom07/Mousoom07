...
ROWS = [
    ...
    ("kv", "Name", "Mousoom Samanta"),
    ("kv", "Role", "AI Engineer"),
    ("kv", "Focus", "Software Developer"),
    ("kv", "Research", "Machine Learning"),
    ("kv", "Degree", "B.Tech CSE"),
    ("kv", "CGPA", "8.88 / 10"),
    ("kv", "Location", "Kolkata, India"),

    ("gap",),

    ("sec", "Experience"),

    ("bul", "IIT Kharagpur - GRISHMA Summer Project Intern"),
    ("bul", "Infosys Springboard - Software Engineering Trainee"),
    ("bul", "Google Summer of Code - Open Source Contributor"),
    ("bul", "Atharvo India - Machine Learning Intern"),

    ("gap",),

    ("sec", "Tech Stack"),

    ("kv", "Languages", "Python | Java | C++ | JavaScript"),
    ("kv", "Frontend", "React | Next.js | Tailwind CSS"),
    ("kv", "Backend", "Node.js | FastAPI"),
